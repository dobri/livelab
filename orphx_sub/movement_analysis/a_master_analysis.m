...
for tr=1:18
    for pp=1:43
        ...
        % Crop the nans. (Preserve the nan index?)
        D(sum(isnan(D),2)>0,:)=[];
...
%{
Useful commands to store the product of this as pic or binary data file.
...
It would be useful to insert here an image-printing option for 
the raw cycle analysis.
